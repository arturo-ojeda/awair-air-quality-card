      ...
      <ha-card style="width: ${this.config.width||"100%"}; height: ${this.config.height||"auto"};">
        <div class="card-wrapper">
          <div class="header">
            ...
            <div class="score" style="color: ${l};">${r}%</div>
          </div>
